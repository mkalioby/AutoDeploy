...
def createIntegrateMessage(jobID,owner, workdir, art_dir, scm,project_name,change_type,change_id, configFile=None, options=None):
    ...
    f += '<art_dir>%s</art_dir>' % str(art_dir)
